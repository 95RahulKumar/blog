import { AppRoutesEnum, IJWTPayload, LsKeyNameEnum } from "@typings/common";
import StorageHandler from "./storageHandeler";
import { isPropEmpty, strCmp } from "./utilFunction";
...
export default class UrlConfigManager extends StorageHandler {
  ...
  initBaseURLConfigurator(apiUrl: string, env: string) {
    ...
    if (this.canOverrideAPI() && env === 'dev') {
